...
Gem::Specification.new do |spec|
  ...
  spec.description = "Raif (Ruby AI Framework) is a Rails engine that helps you add AI-powered features to your Rails apps, such as tasks, conversations, and agents. It supports for multiple LLM providers including OpenAI and AWS Bedrock." # rubocop:disable Layout/LineLength
  spec.license     = "MIT"
